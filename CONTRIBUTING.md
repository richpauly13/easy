...
we use the git commit messages to **generate the [change log](https://github.com/richpauly13/easy/blob/master/CHANGELOG.md)**.
...
2.  Change belongs to a "separated" bigger chunk of a module (eg: `model` from the `schematics` module)
...
Even more [examples](https://github.com/richpauly13/easy/commits/master) of commit messages from the commit history of this project.
