...
import { Component, ElementRef, Input, HostBinding, ViewChild, Directive, NgModule, ViewEncapsulation, Injectable, defineInjectable } from '@angular/core';
...
var ButtonComponent = /** @class */ (function () {
    ...
    ButtonComponent.decorators = [
        { type: Component, args: [{
                    ...
                    template: "<ng-content></ng-content>\n",
                    styles: [":host.btn-full,:host.btn-lg,:host.btn-md,:host.btn-sm,:host.btn-xl,:host.btn-xs{align-content:center;align-items:center;display:flex;justify-content:flex-start;display:inline-flex;justify-content:center;margin-bottom:1rem;margin-right:1rem}:host.btn-full.rounded,:host.btn-lg.rounded,:host.btn-md.rounded,:host.btn-sm.rounded,:host.btn-xl.rounded,:host.btn-xs.rounded{border-radius:1.5rem}:host.btn-xs{padding:.5rem .625rem}:host.btn-sm{padding:.625rem 1.25rem}:host.btn-full,:host.btn-md{padding:.75rem 1.875rem}:host.btn-lg{padding:.875rem 2.5rem}:host.btn-xl{padding:1rem 3.125rem}:host.btn-full{width:100%}:host.btn-group-col,:host.btn-group-full,:host.btn-group-row{align-content:center;align-items:center;display:flex;justify-content:flex-start;padding-bottom:1rem;padding-top:1rem}:host.btn-group-col{align-content:flex-start;align-items:flex-start;display:flex;flex-direction:column;justify-content:center}:host.btn-group-full{width:100%}:host-context(.btn-group-col).btn-lg,:host-context(.btn-group-col).btn-md,:host-context(.btn-group-col).btn-sm,:host-context(.btn-group-col).btn-xl,:host-context(.btn-group-col).btn-xs,:host-context(.btn-group-full).btn-lg,:host-context(.btn-group-full).btn-md,:host-context(.btn-group-full).btn-sm,:host-context(.btn-group-full).btn-xl,:host-context(.btn-group-full).btn-xs,:host-context(.btn-group-row).btn-lg,:host-context(.btn-group-row).btn-md,:host-context(.btn-group-row).btn-sm,:host-context(.btn-group-row).btn-xl,:host-context(.btn-group-row).btn-xs{border-bottom:.0625rem solid #fff;border-left:.0625rem solid #fff;margin:0}:host-context(.btn-group-full).btn-lg,:host-context(.btn-group-full).btn-md,:host-context(.btn-group-full).btn-sm,:host-context(.btn-group-full).btn-xl,:host-context(.btn-group-full).btn-xs{flex-basis:auto;flex-grow:1;flex-shrink:0}"]
                }] }
    ];
    /** @nocollapse */
...
var CardComponent = /** @class */ (function () {
    ...
    CardComponent.decorators = [
        { type: Component, args: [{
                    ...
                    template: "<ng-content></ng-content>\n",
                    styles: [":host.card{align-content:center;align-items:center;display:flex;justify-content:flex-start;display:inline-flex;box-shadow:0 .09375rem .25rem rgba(0,0,0,.24),0 .09375rem .375rem rgba(0,0,0,.12);border:.0625rem solid #bdbdbd;flex-direction:column;margin:.5rem;min-width:25rem;padding:1rem}"]
                }] }
    ];
    /** @nocollapse */
...
var FormComponent = /** @class */ (function () {
    ...
    FormComponent.decorators = [
        { type: Component, args: [{
                    selector: 'ez-form, .fieldset, .field-group, .form-field, .form-h, .form-v, .form-group, .form-label',
                    template: "<ng-content></ng-content>\n",
                    styles: [":host.field-group,:host.form-group,:host.form-h{align-content:center;align-items:center;display:flex;justify-content:flex-start}:host.form-v{align-content:flex-start;align-items:flex-start;display:flex;flex-direction:column;justify-content:center}:host.fieldset{border:.0625rem solid #2196f3;padding:.375rem .625rem .75rem}:host.form-group{margin:-.5rem}:host.field-group{padding:.5rem}:host.form-label{font-size:1.125rem;max-width:8.75rem}:host.form-field{transition-duration:.3s;transition-property:box-shadow;transition-timing-function:linear;background-color:inherit}.form-field:not([multiple]):not(textarea){height:2.5rem}.form-field:focus{box-shadow:0 .09375rem .25rem rgba(33,150,243,.24),0 .09375rem .375rem rgba(33,150,243,.12);border:.0625rem solid #2196f3;padding:.4375rem}.form-field.disabled,.form-field:disabled,.form-field[disabled]{background-color:#2196f3}select:not([multiple]).form-field{padding-left:.375rem}select:not([multiple]).form-field:focus{padding-left:.4375rem}select::-ms-value{background-color:#fafafa;color:#191919}option{color:#bdbdbd}input[type=checkbox],input[type=radio]{margin-right:1rem;vertical-align:middle}.checkbox,.radio{display:none}.checkbox-group .checkbox,.radio-group .radio{flex-basis:0;flex-grow:1;flex-shrink:0;flex-basis:50%}.checkbox-label::before,.radio-label::before{content:'\\00a0';background-color:#efefef;display:inline-block;height:1rem;margin-right:.375rem;vertical-align:middle;width:1rem}.radio-label::before{border-radius:50%}.checkbox:checked+.checkbox-label::before,.radio:checked+.radio-label::before{background-color:#2196f3;border:.125rem solid #efefef}.form-field::-webkit-input-placeholder{color:#bdbdbd;opacity:.54}.form-field:-ms-input-placeholder{color:#bdbdbd}.form-field::-ms-input-placeholder{color:#bdbdbd}.form-field::placeholder{color:#bdbdbd}.form-label:required::after,.form-label[required]::after .form-label.required::after{content:'\\2217';color:#ba000d}"]
                }] }
    ];
    /** @nocollapse */
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent.decorators = [
        { type: Component, args: [{
                    selector: 'ez-nav',
                    template: "<ng-content></ng-content>\n",
                    styles: [".nav-left,.nav-right{overflow-y:auto;width:auto}.nav-bottom .nav-row,.nav-item,.nav-link,.nav-top .nav-row{align-content:center;align-items:center;display:flex;justify-content:flex-start}.nav-bottom .nav-row,.nav-item,.nav-top .nav-row{display:block}.nav-item,.nav-link{color:inherit;justify-content:center;text-align:center;text-decoration:none}.nav-item:hover,.nav-link:hover{cursor:pointer;text-decoration:underline}@media screen and (min-width:48em){.nav-bottom .nav-row,.nav-item,.nav-top .nav-row{display:flex}.nav-item,.nav-link{flex-basis:auto;flex-grow:1;flex-shrink:0}}.nav-left .nav-item,.nav-left .nav-link,.nav-right .nav-item,.nav-right .nav-link{justify-content:flex-start}.nav-link{padding:1rem}.nav-toggle{height:2.5rem;position:relative;width:2.5rem}.nav-toggle::after{content:'';background-color:#fff;box-shadow:0 6px 0 #fff,0 12px 0 #fff;height:.125rem;position:absolute;width:1.5rem}@media screen and (min-width:64em){.nav-toggle{display:none}}"]
                }] }
    ];
    /** @nocollapse */
...
var SpinnerComponent = /** @class */ (function () {
    ...
    SpinnerComponent.decorators = [
        { type: Component, args: [{
                    ...
                    template: "<ng-content></ng-content>\n",
                    styles: [":host.spinner,:host.spinner-dotted{align-content:center;align-items:center;display:flex;justify-content:flex-start;display:inline-flex;-webkit-animation:2s linear infinite spinner;animation:2s linear infinite spinner;border-radius:50%;height:7.5rem;width:7.5rem}:host.spinner{border-color:#efefef #efefef #efefef #2196f3;border-style:solid;border-width:1rem}:host.spinner-dotted{border-style:dotted;border-color:#0069c0 #2196f3 #6ec6ff #39f;border-width:1.125rem .875rem .75rem .5rem}@-webkit-keyframes spinner{from{-webkit-transform:rotate(0);transform:rotate(0)}to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@keyframes spinner{from{-webkit-transform:rotate(0);transform:rotate(0)}to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}"]
                }] }
    ];
    /** @nocollapse */
...
var TableComponent = /** @class */ (function () {
    ...
    TableComponent.decorators = [
        { type: Component, args: [{
                    selector: 'ez-table',
                    template: "<ng-content></ng-content>\n",
                    styles: [".table,.table-cell,.table-header,.table-row{align-content:center;align-items:center;display:flex;justify-content:flex-start;-ms-overflow-style:-ms-autohiding-scrollbar;white-space:nowrap;width:100%}.table{align-items:stretch;border-collapse:collapse;border-spacing:0}@media screen and (min-width:75em){.table{flex-direction:column}}.table-bordered{border:.0625rem solid #000}.table-bordered .table-header{border-bottom:.0625rem solid #000}.table-bordered .table-cell{border-top:.0625rem solid #000;border-right:.0625rem solid #000}.table-bordered .table-cell:last-child{border-right:none}.table-striped .table-row:nth-child(even){background-color:#fafafa}.table-hover .table-row:hover{background-color:#6ec6ff}.table-cell{flex-basis:0;flex-grow:1;flex-shrink:0;align-items:center;justify-content:center;white-space:pre-wrap}"]
                }] }
    ];
    /** @nocollapse */
